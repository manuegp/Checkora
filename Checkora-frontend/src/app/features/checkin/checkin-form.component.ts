...
import { TUI_COUNTRIES, TuiComboBox, TuiFlagPipe, TuiInputDate, TuiSelect } from '@taiga-ui/kit';
import { TUI_ENGLISH_LANGUAGE, TUI_LANGUAGE, TUI_SPANISH_LANGUAGE } from '@taiga-ui/i18n';
...
export class CheckinFormComponent {
  ...
  private readonly countryNames = inject(TUI_COUNTRIES);
